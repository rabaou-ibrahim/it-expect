...
class UsersController
{
    ...
    public function registerValidation()
    {
        ...
        if ($response['success']) {
            $this->userManager->registerDb(htmlspecialchars($_POST["login"]), htmlspecialchars($_POST["lastname"]), htmlspecialchars($_POST['firstname']), htmlspecialchars($_POST["password"]));
            $responseData = [
                'success' => true,
